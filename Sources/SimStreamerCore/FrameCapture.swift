...
///
/// Pipeline: IOSurface (shared memory) -> CVPixelBuffer (zero-copy)
public final class FrameCapture {
    ...
    public func getScreenSize() -> (width: Int, height: Int)? {
    ...
    public static func findSimDevice(udid: String) -> NSObject? {
    ...
    public static func getDeveloperDir() -> String {
        let pipe = Pipe()
        let process = Process()
